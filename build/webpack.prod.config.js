...
var buildConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    // 清理目录
    new CleanWebpackPlugin(['static', 'assets_daohe/static'], {
      root: path.resolve('./dist')
    }),
    // 抽取公共库
    new webpack.DllReferencePlugin({
      name: 'vendor',
      manifest: require('../dist/assets_daohe/vendor-manifest.json')
    }),
    new chunkIdPlugin(),
    ...
    new webpack.optimize.CommonsChunkPlugin({
      ...
      filename: 'assets_daohe/static/js/[name].bundle.[chunkhash:16].js', // 生成后的文件名，虽说用了[name]，但实际上就是'commons.bundle.js'了
      minChunks: 4
    }),
    ...
    new AddAssetHtmlPlugin([
      {
        filepath: 'dist/assets_daohe/dll/*.js',
        publicPath: '/assets_daohe/dll/',
        outputPath: '/assets_daohe/dll',
